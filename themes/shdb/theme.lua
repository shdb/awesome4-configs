...
theme.battery_plus        = path .. "icons/battery_plus.png"
theme.battery_yellow      = path .. "icons/battery_yellow.png"
theme.battery_yellow_plus = path .. "icons/battery_yellow_plus.png"
theme.battery_red         = path .. "icons/battery_red.png"
theme.battery_red_plus    = path .. "icons/battery_red_plus.png"
